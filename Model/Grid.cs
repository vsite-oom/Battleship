...
namespace Vsite.Oom.Battleship.Model
{
    public abstract class  Grid
    {
        ...
        {
            var horizontalPlacements = GetHorizontalAvailablePlacements(length);
            var verticalPlacements = GetVerticalAvailablePlacements(length);
            var allPlacements = horizontalPlacements.Concat(verticalPlacements);
