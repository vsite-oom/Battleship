...
namespace Vsite.Oom.Battleship.Model.Tests
{
    ...
    public class ShotsGridTests
    {
        ...
        [TestMethod]
        public void GetSquaresInDirectionReturns1SquaresAboveSquare3x3IfSqure1x3IsHit()
        {
            var grid = new ShotsGrid(10, 10);
            int row = 3;
            int column = 3;
        ...
        [TestMethod]
        public void GetSquaresInDirectionReturns1SquaresBelowFromSquare7x5IfSquare9x5IsHit()
        {
            var grid = new ShotsGrid(10, 10);
            int row = 7;
            int column = 5;
