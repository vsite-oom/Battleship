namespace Vsite.Oom.Battleship.Model.Tests
{
    ...
    {
        //private IEnumerable<Square> CreateCandidates(ShotsGrid grid, IEnumerable<SquareCoordinate> coordinates)
        //{
        ...
        [TestMethod]
        public void NextReturnsTheOnlySquareAroundSquare3x4AfterSquare3x5And3x3And2x4AreMissed()
        {
            var grid = new ShotsGrid(10, 10);
            var squareHit = grid.Squares.FirstOrDefault(s => s.Row == 3 && s.Column == 4);
            squareHit!.ChangeState(SquareState.Hit);
