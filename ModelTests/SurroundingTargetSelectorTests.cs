...
namespace Vsite.Oom.Battleship.Model.Tests
{
    ...
    public class SurroundingTargetSelectorTests
    {
        ...
        [TestMethod]
        public void NextReturnsOneOfThreeSquaresAroundSquare3x4After3x5IsMissed()
        {
            var grid = new ShotsGrid(10, 10);
            var squareHit = grid.Squares.FirstOrDefault(s => s.Row == 3 && s.Column == 4);
            squareHit!.ChangeState(SquareState.Hit);
        ...
        [TestMethod]
        public void NextReturnsOneOfTwoSquaresAroundSquare3x4After3x5And3x3AreMissed()
        {
            var grid = new ShotsGrid(10, 10);
            var squareHit = grid.Squares.FirstOrDefault(s => s.Row == 3 && s.Column == 4);
            squareHit!.ChangeState(SquareState.Hit);
        ...
        [TestMethod]
        public void NextReturnTheOnlySquareAroundSquare3x4After3x5And3x3And2x4AreMissed()
        {
            var grid = new ShotsGrid(10, 10);
            var squareHit = grid.Squares.FirstOrDefault(s => s.Row == 3 && s.Column == 4);
            squareHit!.ChangeState(SquareState.Hit);
