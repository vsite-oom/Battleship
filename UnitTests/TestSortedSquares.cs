...
namespace Vsite.Oom.Battleship.Model.UnitTests
{
    ...
    {
        [TestMethod]
        public void AfterNewSquaresIsAddedHorizontallySquaresAreSortedByRowAndColumn()
        {
        ...
        [TestMethod]
        public void AfterNewSquaresIsAddedVerticallySquaresAreSortedByRowAndColumn()
        {
            SortedSquares s = new SortedSquares();
