...
namespace Vsite.Oom.Battleship.Model.UnitTests
{
    ...
    public class TestGunner
    {
        [TestMethod]
        public void
        InitiallyShootingTacticsIsRandomAsLongAsFirstSquareIsHit()
        {
        ...
        [TestMethod]
        public void
        ShootingTacticsChangesFromRandomToSurroundingAfterFirstSquareIsHit()
        {
            int[] shipLengths = new int[] { 1, 2, 3 };
            Gunner g = new Gunner(6, 6, shipLengths);
            Assert.AreEqual(ShootingTactics.Random, g.ShootingTactics);
            ...
            Assert.AreEqual(ShootingTactics.Surrounding,
            g.ShootingTactics);
            g.NextTarget();
            g.ProcessHitResult(HitResult.Missed);
            Assert.AreEqual(ShootingTactics.Surrounding,
        ...
        [TestMethod]
        public void
            ShootingTacticsChangesFromRandomToSurroundingToInlineAfterSecondSquareIsHit()
        {
            int[] shipLengths = new int[] { 1, 2, 3 };
            Gunner g = new Gunner(6, 6, shipLengths);
            Assert.AreEqual(ShootingTactics.Random, g.ShootingTactics);
        ...
        [TestMethod]
        public void
            ShootingTacticsChangesFromInlineToRandomAfterShipIsSUnken()
        {
            int[] shipLengths = new int[] { 1, 2, 3 };
            Gunner g = new Gunner(6, 6, shipLengths);
            Assert.AreEqual(ShootingTactics.Random, g.ShootingTactics);
