...
namespace Vsite.Oom.Battleship.Model.UnitTests
{
    ...
    public class TestGunner
    {
        ...
        [TestMethod]
        public void ShootingTacticsChangesFromRandomToSurroundingAfterFirstSqaureIsHit()
        {
            int[] shipLengths = new int[] { 1, 2, 3 };
            Gunner g = new Gunner(6, 6, shipLengths);
            Assert.AreEqual(ShootingTactics.Random, g.ShootingTactics);
        ...
        [TestMethod]
        public void ShootingTacticsChangesFromRandomToSurroundingToInlineAfterSecondSquareIsHit()
        {
            int[] shipLengths = new int[] { 1, 2, 3 };
            Gunner g = new Gunner(6, 6, shipLengths);
            Assert.AreEqual(ShootingTactics.Random, g.ShootingTactics);
        ...
        [TestMethod]
        public void ShootingTacticsChangesFromRandomInlineToRandomAfterShipIsSunk()
        {
            int[] shipLengths = new int[] { 1, 2, 3 };
            Gunner g = new Gunner(6, 6, shipLengths);
            Assert.AreEqual(ShootingTactics.Random, g.ShootingTactics);
