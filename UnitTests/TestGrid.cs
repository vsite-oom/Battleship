...
namespace Vsite.Oom.Battleship.Model.UnitTests
{
    ...
    public class TestGrid
    {
        ...
        [TestMethod]
        public void GetSquaresNextToReturns0SquaresForGrid1x5UAboveAndBelowSquare0x1()
        {
            Grid g = new Grid(1, 5);
        ...
        [TestMethod]
        public void GetSquaresNextToReturns1SquaresForGrid1x5RightAndLeftToSquare0x1()
        {
            Grid g = new Grid(5, 1);
