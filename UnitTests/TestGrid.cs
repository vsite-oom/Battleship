...
namespace Vsite.Oom.Battleship.Model.UnitTests
{
    ...
    public class TestGrid
    {
        ...
        [TestMethod]
        public void GerAvailablePlacementsForShipReturns3PlacementsForShipOfLength2InHorizontalGrid1x6AfterSquareIsEliminated()
        {
            Grid g = new Grid(1, 6);
        ...
        [TestMethod]
        public void GerAvailablePlacementsForShipReturns2PlacementsForShipOfLength2InVerticalGrid5x1AfterSquareIsEliminated()
        {
            Grid g = new Grid(5, 1);
